...
- **Timeframe**: 1h oder kleiner (5m, 15m) — die Strategie ist fuer Intraday-Trading konzipiert
...
- **Maerkte**: Funktioniert am besten in rangegebundenen (Sideways-)Maerkten

## Nutzung
```bash
# Standard-Backtest (1h, BTC/USDT, 6 Monate)
uv run tradestrats backtest -S box -t 1h BTC/USDT

# Mit engerem Stop-Loss
...
- Win Rate: ~56%
- 62 Trades
- Hinweis: Negative Gesamtrendite in Trendmaerkten erwartet — Strategie ist fuer Range-Maerkte optimiert

## Quelle
YouTube: "If I Wanted to Make $1,000 a Day Trading, I'd Do This" — Doug (Box Theory / Previous-Day Range)
